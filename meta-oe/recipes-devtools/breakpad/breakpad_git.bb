...
SRC_URI = "git://github.com/google/breakpad;name=breakpad;protocol=https;branch=main \
           git://github.com/google/googletest.git;destsuffix=git/src/testing/gtest;name=gtest;protocol=https;brandh=main \
           git://github.com/google/protobuf.git;destsuffix=git/src/third_party/protobuf/protobuf;name=protobuf;protocol=https;branch=main \
